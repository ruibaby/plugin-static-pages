...
由于我目前不太确定此插件的实际需求，所以当前的版本仅为需求验证版本，我不能保证后续的维护情况。开发此插件的目的也只是解决我的部分需求，目前能够想到的使用场景：

1. 如上所说，前端开发 er 可能经常需要写 Demo 页面，可以通过此插件快速发布 Demo 页面。这是编写此插件的初衷，也由于 Vercel、Cloudflare Pages、GitHub Pages 在某些地区难以访问，也实在找不到好的替代。
2. 作为 Halo 页面的补充，可以用于部署一些静态页面，比如个人简历、开发工具页面（比如：<https://ryanc.cc/tools/>）等。
...
此插件由我和 @guqing 在业余时间开发，感谢 @guqing。如果此插件对你有帮助，可以在此帖进行反馈。
